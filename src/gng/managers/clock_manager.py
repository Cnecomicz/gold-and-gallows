...
class ClockManager:
    def __init__(self):
        ...
        self.number_of_ticks_in_one_minute = (
            self.number_of_ticks_in_one_second * self.number_of_seconds_in_one_minute
        )
        self.number_of_ticks_in_one_hour = (
            self.number_of_ticks_in_one_minute * self.number_of_minutes_in_one_hour
        )
        self.number_of_ticks_in_one_day = (
            self.number_of_ticks_in_one_hour * self.number_of_hours_in_one_day
        )
        self.number_of_ticks_in_one_week = (
            self.number_of_ticks_in_one_day * self.number_of_days_in_one_week
        )
        self.number_of_ticks_in_one_month = (
            self.number_of_ticks_in_one_day * self.number_of_days_in_one_month
        )
        self.number_of_ticks_in_one_year = (
            self.number_of_ticks_in_one_month * self.number_of_months_in_one_year
        )
        # --------------------------------------------------------------
    ...
    def get_datetime_string(self):
        year = (math.floor(self.ticks_passed / self.number_of_ticks_in_one_year)) + 1
        month_index = (
            math.floor(self.ticks_passed / self.number_of_ticks_in_one_month)
            % self.number_of_months_in_one_year
        )
        day = (
            math.floor(self.ticks_passed / self.number_of_ticks_in_one_day)
            % self.number_of_days_in_one_month
        ) + 1
        hour = (
            math.floor(self.ticks_passed / self.number_of_ticks_in_one_hour)
            % self.number_of_hours_in_one_day
        )
        if hour <= 9:
            hour = f"0{hour}"
        minute = (
            math.floor(self.ticks_passed / self.number_of_ticks_in_one_minute)
            % self.number_of_minutes_in_one_hour
        )
        if minute <= 9:
            minute = f"0{minute}"
        second = (
            math.floor(self.ticks_passed / self.number_of_ticks_in_one_second)
